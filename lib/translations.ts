  ...
  es: {
    ...
    landing: {
      ...
      faq: [
        ...
        { q: '¿Los planes son realmente personalizados?',             a: 'Sí. Cruzamos tus tiempos de referencia, tu peso, tu nivel de sudoración, la altimetría del recorrido y el pronóstico del clima del día exacto de la carrera. No es un plan genérico.' },
      ],
  ...
  en: {
    ...
    landing: {
      ...
      faq: [
        ...
        { q: 'Are the plans really personalized?',                 a: 'Yes. We combine your reference times, weight, sweat rate, course elevation and the actual weather forecast for your exact race day. It\'s not a generic template.' },
      ],
