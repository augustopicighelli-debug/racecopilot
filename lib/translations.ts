...
export const T = {
  es: {
    ...
    landing: {
      ...
      features: [
        { title: 'Tu tiempo objetivo, calculado',  desc: 'Modelos de machine learning basados en evidencia científica predicen tu rendimiento. Tres escenarios — ambicioso, realista y conservador — calibrados con tus tiempos reales.' },
